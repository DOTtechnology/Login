                    ...
                    <div class="scrollbar-sidebar scrollbar-container">
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="mm-active">
                                    <a href="management-dashboard.html">
                    ...
                    <div class="app-header">
                        <div class="page-title-heading">
                            ...
                            <div class="page-title-subheading">
                                <img width="30" class="rounded-circle" src="assets/icons/1.png"> &nbsp T Nagar, Chennai,India
                            ...
                            <div class="app-inner-layout__content">
                                <div class="tab-content">
                                    <div class="container-fluid">
                                        <div class="card mb-3">
                                            <div class="card-header-tab card-header jumbotron m-0">
                                                <div class="card-header-title font-size-lg text-capitalize font-weight-normal">
                                                    <i class="fas fa-user-circle fa-lg"></i>&nbsp;Profile
                                                </div>
                                                <div class="btn-actions-pane-right actions-icon-btn">
                                                    <div class="btn-group dropdown p-2">
                                                        <button class="btn btn-default"><i class="far fa-edit fa-lg"></i></button>
                                                    </div>
                                                </div>
                                              </div>
                                            <div class="card-body py-5">
                                                <div class="row">
                                                    <div class="col-md-3 justify-content-center text-center">
                                                        <div class="profile-image" style="width: 150px; height: 150px; margin: auto; border-radius: 50%;">
                                                            <img src="./assets/images/profile.png" style="width: 100%; height: 100%;" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <strong><h2>Name</h2></strong>
                                                        <strong><h6 class="card-title" style="font-size: 0.9rem;">ShopKeeper</h6></strong>
                                                        <table>
                                                            <tr>
                                                                <td style="vertical-align: top; width: 40%;"><img src="./assets/icons/1.png" width="25" alt="">&nbsp; Address:</td>
                                                                <td style="word-wrap: break-word;">gregg uhvruefbrievnbrebfi rvugdgsfgfdsgfgg</td>
                                                            </tr>
                                                            <tr>
                                                                <td style="vertical-align: top;"><img src="./assets/icons/4.1.webp" width="20" alt="">&nbsp; Contact No.</td>
                                                                <td style="word-wrap: break-word;">1234567890</td>
                                                            </tr>
                                                            <tr>
                                                                <td style="vertical-align: top;"><img src="./assets/icons/2-removebg-preview.png"  width="25" alt="">&nbsp; Email</td>
                                                                <td style="word-wrap: break-word;">abcd@xyz.com</td>
                                                            </tr>
                                                            <tr>
                                                                <td style="vertical-align: top;"><img src="./assets/icons/1200px-Aadhaar_Logo.svg.png"  width="25" alt="">&nbsp; Aadhar No.</td>
                                                                <td style="word-wrap: break-word;">43262673273629783</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="container-fluid">
                                        <div class="card mb-3">
                                            <div class="card-header-tab card-header">
                                                <div class="card-header-title font-size-lg text-capitalize font-weight-normal">Delivery Boys</div>
                                                <div class="btn-actions-pane-right actions-icon-btn">
                                                    <div class="btn-group dropdown">
                                                        <button type="button" data-toggle="modal" data-target="#exampleModal" 
                                                                class="btn-icon btn-icon-only btn btn-link"><img src="assets/icons/button-circle-add-512.webp" width="30px"></button>
                                                    </div>
                                                </div>
                                              </div>
                                            <div class="container-fluid">
                                                    ...
                                                    <div class="col-lg-4 justify-content-center align-items-center mb-4">
                                                        <div class="card" style="width: 100%; box-shadow: 0px 0px 12px rgba(0,0,0,0.6);">
                                                            <div class="profile text-center p-4">
                                                                <div class="circle" style="border-radius: 50%; height: 100px; width: 100px; margin: auto;">
                                                                    <img src="./assets/images/profile.png" class="card-img-top" alt="...">
                                                                </div>
                                                            </div>
                                                            <div class="card-body bg-light">
                                                                <h5 style="font-weight: 60;">Ramu kaka</h5>
                                                              <p class="card-text">
                                                                  <table>
                                                                      <tr>
                                                                      ...
                                                                      <tr>
                                                                          <td style="vertical-align: top; width: 50%;"><img src="./assets/icons/2.png" width="20" alt="">&nbsp; Contact No.</td>
                                                                          <td style="word-wrap: break-word;">1234567890</td>
                                                                      </tr>
                                                                      <tr>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body" >
                    <div class="material-form-field">
                        ...
                        <label class="material-form-field-label" for="field-text">Name</label>
                      </div>
                    <div class="material-form-field">
                        <input type="text" required name="text" id="field-text"/>
                        <label class="material-form-field-label" for="field-text">Address</label>
                      </div>
                    <div class="material-form-field">
                        <input type="text" required name="text" id="field-text"/>
                        <label class="material-form-field-label" for="field-text">Contact No.</label>
                      </div>
                    <div class="material-form-field">
                        <input type="text" required name="text" id="field-text"/>
                        <label class="material-form-field-label" for="field-text">Aadhar ID</label>
                    </div>
                    <div class="material-form-field">
